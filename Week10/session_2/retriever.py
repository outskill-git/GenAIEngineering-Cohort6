...
# 1st step: loading the clip model!
...
# step 2: get our context store ready!
# lanceModel schema defining what a particular row of the dataset looks like
...
# step 3: start extracting the shoe attributes
...
def run_shoes_search(
    ...
    # search_type determines the modality of the search query: image, text, auto
    if search_type == "auto":
